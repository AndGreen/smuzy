...
module.exports = class ColorWheel extends Component {
  // testData = {}
  ...
  wheelWidth = 0;
  static defaultProps = {
    row: true, // use row or vertical layout
  ...
  constructor(props) {
    super(props);
    // const defaultHsv = hex2Hsv(props.defaultColor);
    this.mounted = false;
    this.state = {
      wheelOpacity: 0,
      sliderOpacity: 0,
  ...
  onSliderLayout = e => {
    this.slider.measureInWindow((x, y, width, height) => {
      ...
      // console.log(this.sliderMeasure, this.sliderLength);
  ...
  renderSwatches() {
    this.swatches = this.props.palette.map((c, i) => (
      <View
        style={tw.style(`ml-5 mb-5 w-10 h-10`)}
        key={'S' + i}
  ...
  render() {
    ...
    return (
      <View
        ...
        {/*    </View>*/}
        {/*  ) : (*/}
        {/*    <View style={tw.style('h-8 z-10 rounded-lg')} key={'$2'}>*/}
        {/*      <View style={tw`bg-[${hex}] h-full w-[100vw] rounded-lg`}>*/}
        {/*        <ImageBackground*/}
        {/*          style={ss.sliderImg}*/}
        ...
        {/*{swatches && swatchesLast && (*/}
        {/*  <View*/}
        {/*    style={tw.style(`flex-wrap`, ss.swatches, swatchStyle)}*/}
        {/*    key={'SW'}>*/}
        {/*    {this.swatches}*/}
        {/*  </View>*/}
        {/*)}*/}
